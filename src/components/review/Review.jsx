        ...
        <div className="row text-center">
          <div className="col-md-4 mb-5 mb-md-0">
            <div className="d-flex justify-content-center mb-4">
              <img style={{maxWidth:170,maxHeight:150}}
                src={require('../Assets/image/shoes/1.jpg')}
          ...
          <div className="col-md-4 mb-5 mb-md-0">
            ...
            <p className="px-xl-3">
              <i className="fas fa-quote-left pe-2"></i>Ut enim ad minima veniam,
          ...
          <div className="col-md-4 mb-0">
            ...
            <p className="px-xl-3">
              <i className="fas fa-quote-left pe-2"></i>At vero eos et accusamus et
